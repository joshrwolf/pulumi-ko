...
namespace Pulumi.Ko
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ko.version.txt");
    ...
    internal sealed class KoResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public KoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
