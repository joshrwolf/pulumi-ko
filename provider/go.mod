module github.com/joshrwolf/pulumi-ko/provider

go 1.18

replace (
	github.com/chainguard-dev/terraform-provider-ko/shim => ./shim
...
require (
	github.com/chainguard-dev/terraform-provider-ko/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/chainguard-dev/terraform-provider-ko v0.0.2 // indirect
